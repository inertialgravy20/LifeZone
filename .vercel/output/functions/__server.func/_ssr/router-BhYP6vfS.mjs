...
import { n as auth } from "./server-CA0Ltlt7.mjs";
import { n as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BhYP6vfS.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: error.message || "Si è verificato un errore inatteso. Ricarica la pagina."
			})
		]
	});
}
...
function AppProviders({ children }) {
	const [client] = (0, import_react.useState)(makeClient);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(QueryClientProvider, {
		client,
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
			theme: "dark",
			position: "bottom-center",
			toastOptions: { className: "!bg-surface !text-fg !border-line !rounded-xl !font-[Outfit,sans-serif] !text-sm" }
		})]
	});
}
var styles_default = "/assets/styles-BTJiGmUN.css";
var APP_NAME = "Replay";
...
var Route$7 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Bacheca per giocatori: post, screenshot, clip, like e commenti."
			},
			{
				name: "theme-color",
				content: "#0b0c0a"
...
var $$splitComponentImporter$4 = () => import("./routes-BE9q-coi.mjs");
var Route$6 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./login-DIMYLkeE.mjs");
var Route$5 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./new-D1TRNwKK.mjs");
var Route$4 = createFileRoute("/new")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./p._postId-CpXz_8dx.mjs");
var Route$3 = createFileRoute("/p/$postId")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./u._handle-dTFLjJQt.mjs");
var Route$2 = createFileRoute("/u/$handle")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var Route = createFileRoute("/api/media/$id")({ server: { handlers: { GET: async ({ request }) => {
	...
	if (row.public_path) return Response.redirect(new URL(row.public_path, url.origin), 302);
...
var rootRouteChildren = {
	...
	NewRoute: Route$4.update({
		id: "/new",
		path: "/new",
		getParentRoute: () => Route$7
	}),
	PPostIdRoute: Route$3.update({
		id: "/p/$postId",
		path: "/p/$postId",
		getParentRoute: () => Route$7
	}),
	UHandleRoute: Route$2.update({
		id: "/u/$handle",
		path: "/u/$handle",
		getParentRoute: () => Route$7
	}),
...
//#endregion
export { createSsrRpc as i, Route$2 as n, Route$3 as r, router_exports as t };
